...
export default function DashboardLayout() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 overflow-x-hidden">
      ...
      <a
        href="#main-content"
        className="sr-only focus:not-sr-only focus:fixed focus:top-4 focus:left-4 focus:z-[100] focus:px-4 focus:py-2 focus:bg-black focus:text-white focus:border-2 focus:border-white focus:rounded-lg focus:font-bold focus:outline-none focus:shadow-hard"
      >
      ...
      {/* Floating Help Button - Visible on all screens */}
      <Link
        to="/dashboard/help"
        className="fixed bottom-24 lg:bottom-8 right-4 lg:right-8 z-50 bg-yellow-400 text-black p-3 lg:p-4 rounded-full border-2 border-black shadow-hard hover:-translate-y-1 hover:shadow-hard-lg transition-all"
