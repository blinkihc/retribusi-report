            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <div className={`space-y-6 ${!isDesktop && currentStep === 3 ? 'hidden' : ''}`}>
                ...
                <div className={!isDesktop && currentStep !== 1 ? 'hidden' : ''}>
                  <label htmlFor="opd" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                    OPD <span className="text-red-600">*</span>
                  </label>
                ...
                <div className={!isDesktop && currentStep !== 2 ? 'hidden' : ''}>
                  <label htmlFor="tanggal" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
                    Tanggal Setor <span className="text-red-600">*</span>
                  </label>
                  <DatePicker
              ...
              <div className={`space-y-6 ${!isDesktop && currentStep === 1 ? 'hidden' : ''}`}>
                {/* Nominal */}
                <div className={!isDesktop && currentStep !== 2 ? 'hidden' : ''}>
                  <label htmlFor="nominal" className="block text-xs font-bold uppercase tracking-wider text-slate-700 mb-2">
